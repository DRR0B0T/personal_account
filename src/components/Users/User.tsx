...
export const User = ({first_name, last_name, avatar, email}:{first_name:string, last_name:string, avatar:string, email:string}) => (
    <li>
        <div>
        ...
        <img className="action" src={avatar} alt="Action" />
    </li>
);